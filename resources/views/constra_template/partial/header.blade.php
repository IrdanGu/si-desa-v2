            ...
            <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                <ul class="top-info">
                    <li> &nbsp;&nbsp;&nbsp;<i class="fa fa-map-marker"> &nbsp;</i>
                        <p class="info-text text-center"><b>983872 kab kuningan</b> </p>
                    </li>
                </ul>
            </div>
            <!--/ Top info end -->
                        ...
                        <li>
                            <div class="info-box">
                                <div class="info-box-content">
                                    ...
                                    <p class="info-box-subtitle">mancagar123@gmail.com</p>
                                </div>
                            </div>
                        </li>
                    </ul><!-- Ul end -->
                    ...
                    <div class="site-nav-inner pull-left">
                        ...
                        <div class="collapse navbar-collapse navbar-responsive-collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Karang taruna<i
                                            class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Informasi Desa<i
                                            class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown-menu" role="menu">
