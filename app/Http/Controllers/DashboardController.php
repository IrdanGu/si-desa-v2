...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('dashboard', compact('jmlpenduduk', 'LK', 'P', 'berita', 'user', 'Kpl', 'surat_ku', 'surat_ktm', 'surat_domisili', 'rt01', 'rt02', 'rt03',
            'rt04', 'rt05', 'rt06', 'rt07', 'rt01LK', 'rt01P', 'rt02LK', 'rt02P', 'rt03LK', 'rt03P', 'rt04LK', 'rt04P', 'rt05LK', 'rt05P', 'rt06LK', 'rt06P', 'rt07LK', 'rt07P', 'blm_sklh', 'tdk_prnh_sklh', 'blm_tamat_sd', 'tamat_sd', 'tamat_sltp', 'tamat_slta', 'tamat_s1', 'brh_h_lepas', 'pelajar', 'wiraswasta', 'm_rmh_tangga', 'b_harian_lepas', 'perangkat_desa', 'belum_bekerja', 'karyawan_swasta', 'kawin', 'blm_kawin', 'jandud', 'notifications', 'all_surat', 'status'));
    }
